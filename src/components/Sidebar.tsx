...
const Sidebar: React.FC<SidebarProps> = ({ routes, toggleSidebar }) => {
    ...
    return (
        <div className="flex flex-col bg-white border-r border-grey-light">
                                        ...
                                        {readStatus[route.link] ? (
                                            <svg
                                                ...
                                                <g id="SVGRepo_iconCarrier">
                                                    ...
                                                    <path d="M16 7L12 11" stroke="#3b82f6" stroke-width="1.5"
                                                          stroke-linecap="round"></path>
                                                    <path
                                            ...
                                            <svg
                                                ...
                                                <g id="SVGRepo_iconCarrier">
                                                    <path
                                                        ...
                                                        stroke-linecap="round"></path>
                                                    <path d="M16 7L12 11" stroke="#6b7280" stroke-width="1.5"
                                                          stroke-linecap="round"></path>
                                                    <path
                                                        d="M7 12L11.5757 16.5757C11.8101 16.8101 12.1899 16.8101 12.4243 16.5757L22 7"
                                                        stroke="#6b7280" stroke-width="1.5"
