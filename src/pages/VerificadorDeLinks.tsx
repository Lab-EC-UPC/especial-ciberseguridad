            ...
            <div className="pb-14">
                ...
                <div className="flex flex-col items-end">
                    <div className="chat-box right">
                        ...
                        <div className="flex items-center gap-1">
                            <small className="chat-time">18:50</small>
                            <img src="read-double-check-icon.svg" alt="Double check icon" className="h-4 w-4 md:h-6 md:w-6" />
                        </div>
                    </div>
                </div>
                <div className="flex flex-col items-end">
                ...
                <div className="flex flex-col items-center">
                    <div className="chat-box center">
                        <img src="joined-chat-icon.svg" alt="Joined chat icon" className="w-16 h-16 md:w-24 md:h-24" />
                        <h1 className="text-lg font-medium">Se ha creado la herramienta</h1>
                        <small className="font-medium">Verificador de Enlaces</small>
                        <p className="text-sm md:text-md">¡Puedes estar un paso adelante de los ciberdelincuentes 🚨!</p>
                    </div>
                </div>
                <div className="flex flex-col items-center">
                    <div className="chat-box center">
                ...
                <div className="flex flex-col items-center">
                    <div className="chat-box center">
                        <p className="text-sm md:text-md">Introduce el enlace o escanea el código QR sospechoso para proceder con su verificación.</p>
                    </div>
                </div>
                ...
                {cameraActive && (
                    <div className="fixed inset-0 bg-black bg-opacity-75 flex flex-col items-center justify-center z-50">
                        ...
                        <div className="mt-4 space-x-4">
                            <button onClick={handleTakePhoto} className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md">
                                Tomar Foto
                            </button>
                            <button onClick={handleCloseCamera} className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-md">
                                Cerrar Cámara
                            </button>
                        </div>
                    </div>
                ...
                <div className="fixed bottom-0 w-7/12 bg-gray-300 shadow-lg p-4 flex items-center justify-between z-10">
                    ...
                    >
                        ...
                        {showTooltip1 && <div className="absolute -top-10 bg-white text-xs p-2 rounded shadow-md">Escanea un QR</div>}
                    </div>
                    <div
                        className="relative ml-4 group flex flex-col items-center cursor-pointer"
                    ...
                    >
                        ...
                        {showTooltip2 && <div className="absolute -top-10 bg-white text-xs p-2 rounded shadow-md">Sube un archivo</div>}
                    </div>
                </div>
            </div>
        </>
